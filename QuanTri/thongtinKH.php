                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable">
                                    <thead>
                                        <tr>
                                            <th>
                                                <form action="thongtinKH.php" method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <!-- Topbar Search -->
                                        ...
                                        <tr>
                                            ...
                                            <th style="vertical-align: middle;text-align: center;">SĐT</th>
                                            <th>Số người</th>
                                            <th>Ngày đặt bàn</th>
                                            <th>Giờ nhận</th>
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysqli_query($conn, 'select count(id) as hoten from quanli_datban');
                                    ...
                                    $total_page = ceil($total_records / $limit);
                                       ...
                                       if ($current_page > $total_page){
                                        ...
                                        $result = mysqli_query($conn, "SELECT * FROM quanli_datban LIMIT $start, $limit");
